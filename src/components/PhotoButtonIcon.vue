<template>
  <svg xmlns="http://www.w3.org/2000/svg" class="fill-current text-red-500" viewBox="0 0 512 512">
    <title>Heart</title>
...
<script>
export default {
  name: 'PhotoButtonIcon',
  props: {
    type: String
  },
  mounted() {
    // Check the type of button by retrieving $store values
  }
}
</script>